...
# API-Schlüssel aus config.json laden (App-Ordner, dann Projektwurzel)
...
if not config:
    raise FileNotFoundError(f"config.json not found. Checked: {' | '.join(config_candidates)}")
...
animation_labels = []
is_recording = False
keyboard_enabled = False  # macOS: Hotkeys standardmäßig deaktiviert
